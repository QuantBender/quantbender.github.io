...
(i) Develop an algorithm for computing $v_{n}$ recursively. In particular, write a formula for $v_n$ in terms of $v_{n+1}$.

(ii) Apply the algorithm developed in (i) to compute $v_0(4, 4)$ , the price of the Asian option at time zero.

(iii) Provide a formula for $\delta_{n} ( s, y )$ , the number of shares of stock that should be held by the replicating portfolio at time $n$ if $S_n = s$ and $Y_n = y$
